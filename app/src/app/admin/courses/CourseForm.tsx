...
interface CourseFormProps {
  course?: { id: string; slug: string; title: string; description: string | null; is_premium: boolean; published: boolean; sort_order: number }
}
...
export function CourseForm({ course }: CourseFormProps) {
  ...
  async function handleSave() {
    ...
    setSaving(true)
    const payload = { title: title.trim(), slug: slug.trim(), description: description.trim() || null, is_premium: isPremium, published, sort_order: sortOrder }
